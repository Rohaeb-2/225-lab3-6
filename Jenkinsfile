pipeline {
    ...
    environment {
        ...
        GITHUB_URL = 'https://github.com/Rohaeb-2/225-lab3-6.git'                                          //<------change this
    ...
    steps {
        script {
            // Build test container without Docker login
            sh 'docker build --pull --no-cache -t qa-tests -f Dockerfile.test .'
            // Run Selenium tests
